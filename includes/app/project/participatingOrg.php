...
if($projectRow['FundName'] == "Compact"){
	$accountable = "Millennium Challenge Account - " . $projectRow['MCCCountryName'];
	$implementing = "Millennium Challenge Account - " . $projectRow['MCCCountryName'];
	$accCode = "US-8";
	$impCode = "US-8";
}else{
